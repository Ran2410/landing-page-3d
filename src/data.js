...
export const timelineChapters = [
  ...
  specimenChapter({
    ...
    accent: '#C79A55', image: '/assets/museum/01-coffee-seed-cutout.webp',
  ...
  specimenChapter({
    ...
    accent: '#E9D9B6', image: '/assets/museum/02-cherry-anatomy-cutout.webp',
  ...
  specimenChapter({
    ...
    accent: '#D79A3B', image: '/assets/museum/03-arabica-cutout.webp',
  ...
  specimenChapter({
    ...
    accent: '#91A078', image: '/assets/museum/04-robusta-cutout.webp',
  ...
  specimenChapter({
    ...
    accent: '#C79A55', image: '/assets/museum/05-liberica-excelsa-cutout.webp',
